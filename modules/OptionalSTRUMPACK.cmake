...
if(USE_STRUMPACK)
  ...
  if(STRUMPACK_FOUND)
    ...
    set_property(TARGET strumpack APPEND INTERFACE_LINK_LIBRARIES
                                  ${STRUMPACK_LIBRARIES})
    set_property(TARGET strumpack APPEND COMPILE_DEFINITIONS
                                  "-DWITH_STRUMPACK=1")
    set_property(TARGET strumpack APPEND INTERFACE_INCLUDE_DIRECTORIES
