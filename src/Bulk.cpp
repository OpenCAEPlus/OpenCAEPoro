...
void Bulk::InitPTSw(const USI& tabrow)
{
    ...
    if (Dref < DOGC) {
        ...
        gammaGtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Pgref, Pbb, myTemp, tmpInitZi.data(), GAS);
        ...
        for (USI id = beginId; id > 0; id--) {
            ...
            gammaGtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Pgtmp[id], Pbb, myTemp, tmpInitZi.data(), GAS);
        ...
        for (USI i = 0; i < mynum; i++) {
            ...
            gammaGtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Ptmp, Pbb, myTemp, tmpInitZi.data(), GAS);
            Ptmp += gammaGtmp * mydz;
            myz += mydz;
        }
        Ptmp -= PcGO;
        for (USI i = 0; i < mynum; i++) {
            ...
            gammaOtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Ptmp, Pbb, myTemp, tmpInitZi.data(), OIL);
            Ptmp -= gammaOtmp * mydz;
            myz -= mydz;
        }
        Poref = Ptmp;
        ...
        gammaOtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Poref, Pbb, myTemp, tmpInitZi.data(), OIL);
        ...
        for (USI id = beginId; id > 0; id--) {
            ...
            gammaOtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Potmp[id], Pbb, myTemp, tmpInitZi.data(), OIL);
        ...
        for (USI i = 0; i < mynum; i++) {
            ...
            gammaWtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Ptmp, Pbb, myTemp, tmpInitZi.data(), WATER);
            Ptmp -= gammaWtmp * mydz;
            myz -= mydz;
        }
        Pwref = Ptmp;
        ...
        gammaWtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Pwref, Pbb, myTemp, tmpInitZi.data(), WATER);
        ...
        for (USI id = beginId; id > 0; id--) {
            ...
            gammaWtmp = GRAVITY_FACTOR * flashCal[0]->RhoPhase(Pwtmp[id], Pbb, myTemp, tmpInitZi.data(), WATER);
