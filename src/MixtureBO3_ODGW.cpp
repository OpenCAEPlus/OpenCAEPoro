...
void BOMixture_ODGW::InitFlash(const OCP_DBL& Pin,
                               const OCP_DBL& Pbbin,
                               const OCP_DBL& Tin,
                               const OCP_DBL* Sjin,
                               const OCP_DBL& Vpore,
...
void BOMixture_ODGW::Flash(const OCP_DBL& Pin,
                           const OCP_DBL& Tin,
                           const OCP_DBL* Niin,
                           const USI&     ftype,
                           const USI&     lastNP,
...
#ifdef DEBUG
                if (v[1] <= 0) OCP_ABORT("gas volume <= 0");
#endif // DEBUG
...
void BOMixture_ODGW::FlashDeriv(const OCP_DBL& Pin,
                                const OCP_DBL& Tin,
                                const OCP_DBL* Niin,
                                const USI&     ftype,
                                const USI&     lastNP,
