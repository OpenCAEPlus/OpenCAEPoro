...
{
    OCP_DBL result = (h.p0.x * (h.p1.y * (-h.p2.z - h.p3.z + h.p4.z + h.p5.z) + h.p2.y * (h.p1.z - h.p3.z) + h.p3.y * (h.p1.z + h.p2.z - h.p4.z - h.p7.z) +
        h.p4.y * (-h.p1.z + h.p3.z - h.p5.z + h.p7.z) + h.p5.y * (-h.p1.z + h.p4.z) + h.p7.y * (h.p3.z - h.p4.z)) +
        h.p1.x * (h.p0.y * (+h.p2.z + h.p3.z - h.p4.z - h.p5.z) + h.p2.y * (-h.p0.z - h.p3.z + h.p5.z + h.p6.z) + h.p3.y * (-h.p0.z + h.p2.z) +
            h.p4.y * (h.p0.z - h.p5.z) + h.p5.y * (h.p0.z - h.p2.z + h.p4.z - h.p6.z) + h.p6.y * (-h.p2.z + h.p5.z)) +
        h.p2.x * (h.p0.y * (-h.p1.z + h.p3.z) + h.p1.y * (h.p0.z + h.p3.z - h.p5.z - h.p6.z) + h.p3.y * (-h.p0.z - h.p1.z + h.p6.z + h.p7.z) +
            h.p5.y * (h.p1.z - h.p6.z) + h.p6.y * (h.p1.z - h.p3.z + h.p5.z - h.p7.z) + h.p7.y * (-h.p3.z + h.p6.z)) +
        h.p3.x * (h.p0.y * (-h.p1.z - h.p2.z + h.p4.z + h.p7.z) + h.p1.y * (h.p0.z - h.p2.z) + h.p2.y * (h.p0.z + h.p1.z - h.p6.z - h.p7.z) +
            h.p4.y * (-h.p0.z + h.p7.z) + h.p6.y * (h.p2.z - h.p7.z) + h.p7.y * (-h.p0.z + h.p2.z - h.p4.z + h.p6.z)) +
        h.p4.x * (h.p0.y * (h.p1.z - h.p3.z + h.p5.z - h.p7.z) + h.p1.y * (-h.p0.z + h.p5.z) + h.p3.y * (h.p0.z - h.p7.z) +
            h.p5.y * (-h.p0.z - h.p1.z + h.p6.z + h.p7.z) + h.p6.y * (-h.p5.z + h.p7.z) + h.p7.y * (h.p0.z + h.p3.z - h.p5.z - h.p6.z)) +
        h.p5.x * (h.p0.y * (h.p1.z - h.p4.z) + h.p1.y * (-h.p0.z + h.p2.z - h.p4.z + h.p6.z) + h.p2.y * (-h.p1.z + h.p6.z) +
            h.p4.y * (h.p0.z + h.p1.z - h.p6.z - h.p7.z) + h.p6.y * (-h.p1.z - h.p2.z + h.p4.z + h.p7.z) + h.p7.y * (h.p4.z - h.p6.z)) +
        h.p6.x * (h.p1.y * (h.p2.z - h.p5.z) + h.p2.y * (-h.p1.z + h.p3.z - h.p5.z + h.p7.z) + h.p3.y * (-h.p2.z + h.p7.z) +
            h.p4.y * (h.p5.z - h.p7.z) + h.p5.y * (h.p1.z + h.p2.z - h.p4.z - h.p7.z) + h.p7.y * (-h.p2.z - h.p3.z + h.p4.z + h.p5.z)) +
        h.p7.x * (h.p0.y * (-h.p3.z + h.p4.z) + h.p2.y * (h.p3.z - h.p6.z) + h.p3.y * (h.p0.z - h.p2.z + h.p4.z - h.p6.z) +
            h.p4.y * (-h.p0.z - h.p3.z + h.p5.z + h.p6.z) + h.p5.y * (-h.p4.z + h.p6.z) + h.p6.y * (h.p2.z + h.p3.z - h.p4.z - h.p5.z))
        ) / 12;
    return result;
}
...
OCP_DBL CalAreaNotQuadr(const HexahedronFace& FACE1, const HexahedronFace& FACE2)
{
    ...
    if ((crosspoint[0].x - Line1[0].x) * (crosspoint[0].x - Line1[1].x) < 0) iret = iret + 1;
    //
    //   Line2 & Line3
    //
    ...
    if ((crosspoint[1].x - Line1[0].x) * (crosspoint[1].x - Line1[1].x) < 0) iret = iret + 2;
    //
    //   Line1 & Line4
    //
    Line1[0] = Point2D(FACE1.p0.x, FACE1.p0.y);
    ...
    if ((crosspoint[2].x - Line1[0].x) * (crosspoint[2].x - Line1[1].x) < 0) iret = iret + 4;
    //
    //   Line2 & Line4
    //
    Line1[0] = Point2D(FACE1.p2.x, FACE1.p2.y);
    ...
    if ((crosspoint[3].x - Line1[0].x) * (crosspoint[3].x - Line1[1].x) < 0) iret = iret + 8;
    //
    ...
    case 1:
        ...
        FACEtmp1.p2 = Point3D(0.5 * (FACEtmp1.p3.x + FACEtmp2.p2.x), 0.5 * (FACEtmp1.p3.y + FACEtmp2.p2.y), 0);
    ...
    case 8:
        ...
        FACEtmp1.p1 = Point3D(0.5 * (FACEtmp1.p0.x + FACEtmp2.p1.x), 0.5 * (FACEtmp1.p0.y + FACEtmp2.p1.y), 0);
...
void ConnGrid::AddHalfConn(const OCP_USI& n, const Point3D& area, const Point3D& d, const USI& direction)
{
    if (nConn >= maxConn) {
        maxConn *= 2;
        halfConn.resize(maxConn);
...
void COORD::CalConn()
{
    ...
    OCP_USI nxy = nx * ny;
    OCP_DBL xvalue, yvalue, zvalue, xtop, ytop, ztop, xbottom, ybottom, zbottom; // value used in assembling the grid points
    ...
    //
    //------------------------------------------------------CODE SEPERATPR-----------------------------------------------------
    //set the points, depth and volume
    for (iloopz = 0; iloopz < nz; iloopz++) {
        for (iloopy = 0; iloopy < ny; iloopy++) {
            for (iloopx = 0; iloopx < nx; iloopx++) {
                ...
                cornerPoints[iloopx][iloopy][iloopz].p0 = Point3D(xvalue, yvalue, zvalue);
                zvalue = ZCORNDATA[iloopx][iloopy][iloopz][4];
                xvalue = xbottom - (zbottom - zvalue) / (zbottom - ztop) * (xbottom - xtop);
                yvalue = ybottom - (zbottom - zvalue) / (zbottom - ztop) * (ybottom - ytop);
                cornerPoints[iloopx][iloopy][iloopz].p4 = Point3D(xvalue, yvalue, zvalue);
                //
                ...
                xvalue = xbottom - (zbottom - zvalue) / (zbottom - ztop) * (xbottom - xtop);
                yvalue = ybottom - (zbottom - zvalue) / (zbottom - ztop) * (ybottom - ytop);
                cornerPoints[iloopx][iloopy][iloopz].p1 = Point3D(xvalue, yvalue, zvalue);
                zvalue = ZCORNDATA[iloopx][iloopy][iloopz][5];
                xvalue = xbottom - (zbottom - zvalue) / (zbottom - ztop) * (xbottom - xtop);
                yvalue = ybottom - (zbottom - zvalue) / (zbottom - ztop) * (ybottom - ytop);
                cornerPoints[iloopx][iloopy][iloopz].p5 = Point3D(xvalue, yvalue, zvalue);
                //
                ...
                xvalue = xbottom - (zbottom - zvalue) / (zbottom - ztop) * (xbottom - xtop);
                yvalue = ybottom - (zbottom - zvalue) / (zbottom - ztop) * (ybottom - ytop);
                cornerPoints[iloopx][iloopy][iloopz].p2 = Point3D(xvalue, yvalue, zvalue);
                zvalue = ZCORNDATA[iloopx][iloopy][iloopz][6];
                xvalue = xbottom - (zbottom - zvalue) / (zbottom - ztop) * (xbottom - xtop);
                yvalue = ybottom - (zbottom - zvalue) / (zbottom - ztop) * (ybottom - ytop);
                cornerPoints[iloopx][iloopy][iloopz].p6 = Point3D(xvalue, yvalue, zvalue);
                //
                ...
                xvalue = xbottom - (zbottom - zvalue) / (zbottom - ztop) * (xbottom - xtop);
                yvalue = ybottom - (zbottom - zvalue) / (zbottom - ztop) * (ybottom - ytop);
                cornerPoints[iloopx][iloopy][iloopz].p3 = Point3D(xvalue, yvalue, zvalue);
                zvalue = ZCORNDATA[iloopx][iloopy][iloopz][7];
                xvalue = xbottom - (zbottom - zvalue) / (zbottom - ztop) * (xbottom - xtop);
                yvalue = ybottom - (zbottom - zvalue) / (zbottom - ztop) * (ybottom - ytop);
                cornerPoints[iloopx][iloopy][iloopz].p7 = Point3D(xvalue, yvalue, zvalue);
                //
                //------------------------------------------------------CODE SEPERATPR-----------------------------------------------------
                ...
                //
                // NOTE: if there are several points not well ordered, the calculated volume will be negative.
                //
    ...
    //
    //            ------------------------------------------------------CODE SEPERATPR-----------------------------------------------------
    //                calculate the half-transmissibilities of each face of each block and each non-neighbor connection.
    //
            ...
            for (iloopx = 0; iloopx < nx; iloopx++) {
                ...
                //
                {
                    ...
                    if (iloopx == 0 || ((Pctof * Pctof) < TEENY)) {
                        ...
                        LGZERO2 = false;
                        LGZERO3 = false;
                        Hexahedron& leftblock = cornerPoints[iloopx - 1][iloopy][iloopz];
                        ...
                        //
                        // consider this situation, the edges of two faces may cross, so the shape of the common area may be irregular.
                        //
                        if (((FACE.p0.z > FACE.p1.z) != (FACE.p3.z > FACE.p2.z)) ||
                            ((LGNNCPOINT0 != LGNNCPOINT3) && (!LGZERO0) && (!LGZERO3)) ||
                            ((LGNNCPOINT1 != LGNNCPOINT2) && (!LGZERO1) && (!LGZERO2))) {
                        ...
                        //   calculate the half-transmissibilities of these non-neighbor connections
                        //
                        ...
                        while (LGLOWERNNC) {
                            ...
                            LGZERO2 = false;
                            LGZERO3 = false;
                            Hexahedron& leftnncblock = cornerPoints[iloopx - 1][iloopy][iloopz + iznnc];
                            ...
                            if (FACE.p1.z <= block.p0.z && FACE.p2.z <= block.p3.z) {
                            ...
                            else if (FACE.p0.z >= block.p4.z && FACE.p3.z >= block.p7.z) {
                                FACE.p0 = FACE.p1;
                                FACE.p3 = FACE.p2;
                            }
                            else {
                                if (((FACE.p0.z > FACE.p1.z) != (FACE.p3.z > FACE.p2.z)) ||
                                    ...
                                    FACE1.p2 = Point3D(block.p4.y, block.p4.z, 0);
                                    FACE1.p3 = Point3D(block.p7.y, block.p7.z, 0);
                                    FACE2.p0 = Point3D(leftnncblock.p2.y, leftnncblock.p2.z, 0);
                                    FACE2.p1 = Point3D(leftnncblock.p1.y, leftnncblock.p1.z, 0);
                                    FACE2.p2 = Point3D(leftnncblock.p5.y, leftnncblock.p5.z, 0);
                                    FACE2.p3 = Point3D(leftnncblock.p6.y, leftnncblock.p6.z, 0);
                                    area = Point3D(-CalAreaNotQuadr(FACE1, FACE2), 0, 0);
                                    if (areavector.x != 0) {
                                        area.y = areavector.y / areavector.x * area.x;
                                        area.z = areavector.z / areavector.x * area.x;
                        ...
                        while (LGUPPERNNC) {
                            ...
                            else if (FACE.p1.z <= block.p0.z && FACE.p2.z <= block.p3.z) {
                                FACE.p1 = FACE.p0;
                                FACE.p2 = FACE.p3;
                            }
                            else {
                ...
                //
                {
                    ...
                    if (iloopx == nx - 1 || ((Pctof * Pctof) < TEENY)) {
                        ...
                        LGZERO2 = false;
                        LGZERO3 = false;
                        Hexahedron& rightblock = cornerPoints[iloopx + 1][iloopy][iloopz];
                        imim = (iloopz)*nxy + iloopy * nx + iloopx + 1;
                        ...
                        if (((FACE.p0.z > FACE.p3.z) != (FACE.p1.z > FACE.p2.z)) ||
                            ((LGNNCPOINT0 != LGNNCPOINT1) && (!LGZERO0) && (!LGZERO1)) ||
                            ((LGNNCPOINT3 != LGNNCPOINT2) && (!LGZERO3) && (!LGZERO2))) {
                        ...
                        while (LGLOWERNNC) {
                            ...
                            LGZERO2 = false;
                            LGZERO3 = false;
                            Hexahedron& rightnncblock = cornerPoints[iloopx + 1][iloopy][iloopz + iznnc];
                            imim = (iloopz + iznnc) * nxy + iloopy * nx + iloopx + 1;
                            ...
                            if (FACE.p3.z <= block.p1.z && FACE.p2.z <= block.p2.z) {
                            ...
                            else if (FACE.p0.z >= block.p5.z && FACE.p1.z >= block.p6.z) {
                                FACE.p0 = FACE.p3;
                                FACE.p1 = FACE.p2;
                            }
                            else {
                                if (((FACE.p0.z > FACE.p3.z) != (FACE.p1.z > FACE.p2.z)) ||
                                    ...
                                    FACE1.p2 = Point3D(block.p6.y, block.p6.z, 0);
                                    FACE1.p3 = Point3D(block.p5.y, block.p5.z, 0);
                                    FACE2.p0 = Point3D(rightnncblock.p0.y, rightnncblock.p0.z, 0);
                                    FACE2.p1 = Point3D(rightnncblock.p3.y, rightnncblock.p3.z, 0);
                                    FACE2.p2 = Point3D(rightnncblock.p7.y, rightnncblock.p7.z, 0);
                                    FACE2.p3 = Point3D(rightnncblock.p4.y, rightnncblock.p4.z, 0);
                                    area = Point3D(CalAreaNotQuadr(FACE1, FACE2), 0, 0);
                                    if (areavector.x != 0) {
                                        area.y = areavector.y / areavector.x * area.x;
                                        area.z = areavector.z / areavector.x * area.x;
                        ...
                        while (LGUPPERNNC) {
                            ...
                            else if (FACE.p3.z <= block.p1.z && FACE.p2.z <= block.p2.z) {
                                FACE.p3 = FACE.p0;
                                FACE.p2 = FACE.p1;
                            }
                            else {
                ...
                //
                {
                    ...
                    if (iloopy == 0 || ((Pctof * Pctof) < TEENY)) {
                        ...
                        LGZERO2 = false;
                        LGZERO3 = false;
                        Hexahedron& frontblock = cornerPoints[iloopx][iloopy - 1][iloopz];
                        ...
                        while (LGLOWERNNC) {
                            ...
                            LGZERO2 = false;
                            LGZERO3 = false;
                            Hexahedron& frontnncblock = cornerPoints[iloopx][iloopy - 1][iloopz + iznnc];
                            ...
                            if (FACE.p3.z <= block.p0.z && FACE.p2.z <= block.p1.z) {
                            ...
                            else if (FACE.p0.z >= block.p4.z && FACE.p1.z >= block.p5.z) {
                                FACE.p1 = FACE.p2;
                                FACE.p0 = FACE.p3;
                            }
                            else {
                                if (((FACE.p0.z > FACE.p3.z) != (FACE.p1.z > FACE.p2.z)) ||
                                    ...
                                    FACE1.p2 = Point3D(block.p5.x, block.p5.z, 0);
                                    FACE1.p3 = Point3D(block.p4.x, block.p4.z, 0);
                                    FACE2.p0 = Point3D(frontnncblock.p3.x, frontnncblock.p3.z, 0);
                                    FACE2.p1 = Point3D(frontnncblock.p2.x, frontnncblock.p2.z, 0);
                                    FACE2.p2 = Point3D(frontnncblock.p6.x, frontnncblock.p6.z, 0);
                                    FACE2.p3 = Point3D(frontnncblock.p7.x, frontnncblock.p7.z, 0);
                                    area = Point3D(0, -CalAreaNotQuadr(FACE1, FACE2), 0);
                                    if (areavector.y != 0) {
                                        area.x = areavector.x / areavector.y * area.y;
                                        area.z = areavector.z / areavector.y * area.y;
                        ...
                        while (LGUPPERNNC) {
                            ...
                            else if (FACE.p3.z <= block.p0.z && FACE.p2.z <= block.p1.z) {
                                FACE.p3 = FACE.p0;
                                FACE.p2 = FACE.p1;
                            }
                            else {
                ...
                //
                {
                    ...
                    if (iloopy == ny - 1 || ((Pctof * Pctof) < TEENY)) {
                        ...
                        LGZERO2 = false;
                        LGZERO3 = false;
                        Hexahedron& backblock = cornerPoints[iloopx][iloopy + 1][iloopz];
                        imim = (iloopz)*nxy + (iloopy + 1) * nx + iloopx;
                        ...
                        while (LGLOWERNNC) {
                            ...
                            LGZERO2 = false;
                            LGZERO3 = false;
                            Hexahedron& backnncblock = cornerPoints[iloopx][iloopy + 1][iloopz + iznnc];
                            imim = (iloopz + iznnc) * nxy + (iloopy + 1) * nx + iloopx;
                            ...
                            if (FACE.p1.z <= block.p3.z && FACE.p2.z <= block.p2.z) {
                            ...
                            else if (FACE.p0.z >= block.p7.z && FACE.p3.z >= block.p6.z) {
                                FACE.p0 = FACE.p1;
                                FACE.p3 = FACE.p2;
                            }
                            else {
                                if (((FACE.p0.z > FACE.p1.z) != (FACE.p3.z > FACE.p2.z)) ||
                                    ...
                                    FACE1.p2 = Point3D(block.p7.x, block.p7.z, 0);
                                    FACE1.p3 = Point3D(block.p6.x, block.p6.z, 0);
                                    FACE2.p0 = Point3D(backnncblock.p1.x, backnncblock.p1.z, 0);
                                    FACE2.p1 = Point3D(backnncblock.p0.x, backnncblock.p0.z, 0);
                                    FACE2.p2 = Point3D(backnncblock.p4.x, backnncblock.p4.z, 0);
                                    FACE2.p3 = Point3D(backnncblock.p5.x, backnncblock.p5.z, 0);
                                    area = Point3D(0, CalAreaNotQuadr(FACE1, FACE2), 0);
                                    if (areavector.y != 0) {
                                        area.x = areavector.x / areavector.y * area.y;
                                        area.z = areavector.z / areavector.y * area.y;
                        ...
                        while (LGUPPERNNC) {
                            ...
                            else if (FACE.p1.z <= block.p3.z && FACE.p2.z <= block.p2.z) {
                                FACE.p1 = FACE.p0;
                                FACE.p2 = FACE.p3;
                            }
                            else {
                ...
                //
                //------------------------------------------------------CODE SEPERATPR-----------------------------------------------------
                //    save evaluated DX,DY,DZ, which would only be used in calculating well bore diameter.
                //    It should not be used at any other place.
                //

                dx[im] = sqrt(dxpoint.x * dxpoint.x + dxpoint.y * dxpoint.y + dxpoint.z * dxpoint.z);
                dy[im] = sqrt(dypoint.x * dypoint.x + dypoint.y * dypoint.y + dypoint.z * dypoint.z);
                dz[im] = sqrt(dzpoint.x * dzpoint.x + dzpoint.y * dzpoint.y + dzpoint.z * dzpoint.z);
    ...
    for (OCP_USI n = 0; n < numGrid; n++) {
        for (USI j = 0; j < blockconn[n].nConn; j++) {
            ...
            if (blockconn[n].halfConn[j].Ad_dd <= 0 || blockconn[nn].halfConn[jj].Ad_dd <= 0) {
                // false connection
                continue;
            }
            //
