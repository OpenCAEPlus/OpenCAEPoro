...
void MixtureComp::InitFlash(const OCP_DBL& Pin,
                            const OCP_DBL& Pbbin,
                            const OCP_DBL& Tin,
                            const OCP_DBL* Sjin,
                            const OCP_DBL& Vpore,
...
void MixtureComp::InitFlashDer(const OCP_DBL& Pin,
                               const OCP_DBL& Pbbin,
                               const OCP_DBL& Tin,
                               const OCP_DBL* Sjin,
                               const OCP_DBL& Vpore,
...
void MixtureComp::InitFlashDer_n(const OCP_DBL& Pin,
                                 const OCP_DBL& Pbbin,
                                 const OCP_DBL& Tin,
                                 const OCP_DBL* Sjin,
                                 const OCP_DBL& Vpore,
...
void MixtureComp::Flash(const OCP_DBL& Pin,
                        const OCP_DBL& Tin,
                        const OCP_DBL* Niin,
                        const USI&     Myftype,
                        const USI&     lastNP,
...
void MixtureComp::FlashDeriv(const OCP_DBL& Pin,
                             const OCP_DBL& Tin,
                             const OCP_DBL* Niin,
                             const USI&     Myftype,
                             const USI&     lastNP,
