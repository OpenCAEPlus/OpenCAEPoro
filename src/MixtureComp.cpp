                             ...
                             const OCP_DBL* lastKs)
{
    ...
    if (NP == 2 && false) {
        ...
        //cout << "rhsDer" << endl;
        //for (USI n = 0; n < NP * NC; n++) {
        //    for (USI i = 0; i < NC + 1; i++) {
        //        cout << rhsDer[i * (NP * NC) + n] << "   ";
        //    }
        //    cout << endl;
        //}
        //cout << endl;
        ...
        CalXiPNX_full01();
        vector<OCP_DBL> tmpxiN(xiN);
        vector<OCP_DBL> tmpxiP(xiP);
        CalXiPNX_partial();
        // Water Properties
        USI Wpid = numPhase - 1;
        USI Wcid = numCom - 1;
        ...
        for (USI j = 0; j < NP; j++) {
            ...
            cout << tmpxiP[j1] << "   ";
            for (USI i = 0; i < numCom; i++) {
                cout << tmpxiN[j1 * numCom + i] << "   ";
            }
            cout << endl;
            cout << rhoP[j1] << "   ";
            for (USI i = 0; i < numCom; i++) {
                cout << rhoN[j1 * numCom + i] << "   ";
            }
            cout << endl;
            cout << muP[j1] << "   ";
            for (USI i = 0; i < numCom; i++) {
                cout << muN[j1 * numCom + i] << "   ";
            }
            cout << endl;
        }
        cout << endl;
