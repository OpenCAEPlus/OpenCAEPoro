...
protected:
    ...
    OCP_BOOL simple_hvap{ OCP_FALSE }; ///< Calculated enthalpy of fluid with simple enthalpy of evaporation
    ...
    vector<OCP_DBL>   data;   ///< Auxiliary variables used to calculate viscosity with interpolating tab
    vector<OCP_DBL>   cdata;  ///< Auxiliary variables used to calculate viscosity with interpolating tab
};
