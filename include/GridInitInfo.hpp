/*! \file    GridInitInfo.hpp
 *  \brief   GridInitInfo class declaration
 *  \author  Shizhe Li
 *  \date    Dec/08/2022
 *
 *-----------------------------------------------------------------------------------
 *  Copyright (C) 2022--present by the OpenCAEPoro team. All rights reserved.
 *  Released under the terms of the GNU Lesser General Public License 3.0 or later.
 *-----------------------------------------------------------------------------------
 */

#ifndef __GRIDINITINFO_HEADER__
#define __GRIDINITINFO_HEADER__
...
public:
    ...
    GPair(const OCP_USI& Id, const USI& Direct, const OCP_DBL& AreaB, const OCP_DBL& AreaE)
        : id(Id), direction(Direct), areaB(AreaB), areaE(AreaE) {};
    ...
    OCP_DBL areaB; ///< Effective intersection area between this cell and the neighbor, self
    OCP_DBL areaE; ///< Effective intersection area between this cell and the neighbor, neighbor
};
...
protected:
    ...
    vector<OCP_USI> map_Act2All;    ///< Mapping from active grid to all grid: activeGridNum.
...
#endif /* end if __GRIDINITINFO_HEADER__ */
