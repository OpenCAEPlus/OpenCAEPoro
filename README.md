...
The directory structure of OpenCAEPoro is designed as follows:
  ...
  - docs: Html files automatically generated by Doxygen (should move to doc in the future)
  ...
  - .npmrc, pnpm-lock.yaml, pnpm-workspace.yaml, package.json: Files related to build the OpenCAEPoro website
